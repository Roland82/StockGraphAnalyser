namespace GraphAnalyser.Tests.Processing.Calculators
{
    ...
    {
        [Test]
        public void TestCalculateWithNoDate() {
        ...
        private Dictionary<DateTime, decimal> SetupClosingPrices() {
            return GraphPlottingUtilities.CreateGraph(new DateTime(2009, 5, 29), new[]{
