    ...
    public class StandardDeviationCalculatorTests
    {
        ...
        public void Test()
        {
            var closingPrices = GraphPlottingUtilities.CreateGraph(new DateTime(2009, 5, 29), new[]{
                ...
                89.83m, 89.74m, 90.40m, 90.74m, 88.02m, 88.09m, 88.84m, 90.78m, 90.54m, 91.39m, 90.65m }, skipWeekends: true);
            ...
            var calculator = new StandardDeviationCalculator(closingPrices);
